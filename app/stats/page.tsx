...
const primaryStats = [
  ...
  },
  {
    ...
    value: "42+",
    detail: "Isolated microservices deployed",
    icon: Container,
  },
  {
...
const quirkyStats = [
  ...
  },
  {
    ...
    value: "Claude Code + AGY",
    description: "Daily pairing with Claude Code, Antigravity CLI, and Codex for multi-agent code refactoring and autonomous developer harnesses.",
    icon: Bot,
    tag: "AI Harness",
  },
  {
    ...
    value: "CLI-First + ⌘K",
    description: "Keyboard-first velocity utilizing Claude Code REPLs, Antigravity CLI, and rapid command palette navigation.",
    icon: Terminal,
    tag: "Developer Flow",
  },
  {
